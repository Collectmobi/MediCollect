...
public class SignupActivity extends AppCompatActivity {
    ...
    public void signup() {
        ...
        progressDialog.setMessage("Firebase registering...");
        progressDialog.show();
        ...
        if(!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !reEnterPassword.isEmpty()){
            if(password.toString().equals(reEnterPassword.toString())){
                fireAuth.createUserWithEmailAndPassword(email, password).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                      //config.toast(getApplicationContext(),"Authentification echouée");
                        Toast.makeText(getApplicationContext(),"Utilisateur echouée !", Toast.LENGTH_LONG).show();
                    }
                });
            }
        }
